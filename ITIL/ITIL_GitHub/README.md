...
![Universidad Autónoma del Estado de México](imagenes/image1.jpeg)
...
![Creación de cuenta de Microsoft Azure](imagenes/image2.png)

Después creamos la cuenta de Alassia.

![Creación de cuenta de Alassia](imagenes/image3.png)
...
![Laboratorio de red en la nube](imagenes/image4.png)

Creamos nuestros **Resource Groups**.

![Resource Groups](imagenes/image5.png)

Dentro tenemos todas nuestras redes, discos y los elementos necesarios para nuestra red en la nube.

![Recursos de la red en la nube](imagenes/image6.png)
...
![Primera máquina virtual](imagenes/image7.png)
...
![Instalación de Apache](imagenes/image10.png)

Vemos que ya está establecida la conexión.

![Conexión al servidor web](imagenes/image11.png)
